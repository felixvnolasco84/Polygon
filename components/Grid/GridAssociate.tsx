...
const GridAssociate = ({ items }: any) => {
  return (
    <div className="flex hidden flex-col gap-y-7 px-4 lg:block lg:gap-y-[50px] lg:px-24">
      <h4
        className={`${neueLight.className} text-2xl lg:text-7xl text-black-500 lg:leading-none`}
      >
